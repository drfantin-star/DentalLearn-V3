...
export default function LeaderboardPanel({ userId, onViewHistory, compact = false, refreshTrigger, mode = 'weekly' }: LeaderboardPanelProps) {
  ...
  if (loading) {
    return (
      <div className={`bg-gradient-to-br from-[#0F766E] to-accent rounded-[20px] shadow-lg ${compact ? 'p-4' : 'p-6'} text-white h-full flex flex-col`}>
  ...
  if (compact) {
    ...
    return (
      <div className="bg-gradient-to-br from-[#0F766E] to-accent rounded-[20px] shadow-lg p-4 md:p-5 text-white h-full flex flex-col">
        <style jsx>{`
