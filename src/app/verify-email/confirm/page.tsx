        ...
        {status === 'error' && (
          <>
            <div className="text-center mb-6">
              ...
              <h1 className="text-2xl font-bold text-primary mb-2">Lien invalide ou expiré</h1>
              <p className="text-gray-600 text-sm">
            ...
            <div className="space-y-3">
              <Link
                href="/login"
                className="block w-full text-center py-3 bg-primary text-white rounded-lg font-medium hover:bg-[#231470] transition-colors"
              >
                Se connecter
              </Link>
              <Link
