-- Nom du fichier : 20260723f_news_score_articles_cron_timeout_down.sql
-- Date de création : 2026-07-23
-- Ticket : news-pipeline-dedup-sizing
-- Description : Rollback — restaure le schedule sans timeout_milliseconds
-- Rollback : n/a (ce fichier EST le rollback de 20260723f_news_score_articles_cron_timeout.sql)
...
-- ============================================================================
-- 2. Restore canonique news_score_articles (lundi 14h00 UTC, limit:50, sans timeout)
-- ============================================================================
...
--
-- Résultat attendu : 1 ligne, schedule='0 14 * * 1', active=true, command SANS
