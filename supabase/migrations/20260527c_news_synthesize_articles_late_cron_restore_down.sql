-- Nom du fichier : 20260527c_news_synthesize_articles_late_cron_restore_down.sql
-- Date de création : 2026-05-27
-- Ticket : fix bug d'idempotence synthesize_articles (claude/fix-synthesize-idempotence-27mai2026)
-- Description : Rollback symétrique — unschedule du job news_synthesize_articles_late
-- Rollback : n/a (ce fichier EST le rollback de 20260527c_news_synthesize_articles_late_cron_restore.sql)
